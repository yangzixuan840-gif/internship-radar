...
COMPANIES = [
    ...
    ("小米", "https://xiaomi.jobs.f.mioffice.cn/internship", "active", "公开实习职位 API（单次最多 100 条）"),
    ("途虎养车", "https://tuhu.jobs.feishu.cn/", "planned", "官方招聘系统入口，待验证低频公开接口"),
    ("拼多多", "https://careers.pinduoduo.com/", "planned", "官方校园招聘入口，待验证低频公开接口"),
    ("OPPO", "https://careers.oppo.com/", "active", "公开实习职位 API（单次最多 100 条）"),
    ("vivo", "https://hr-campus.vivo.com/", "active", "公开实习职位 API（单次最多 100 条）"),
    ...
    ("MiniMax", "https://vrfi1sk8a0.jobs.feishu.cn/379481", "active", "公开实习职位 API（单次最多 100 条）"),
    ...
    ("星猿哲科技", "https://xyzrobotics.jobs.feishu.cn/2026/", "active", "公开校园职位 API（当前无开放实习岗位，持续轮询）"),
    ("千寻智能", "https://nwd4iy9rd2s.jobs.feishu.cn/campusofSpiritAI", "active", "公开实习职位 API（单次最多 100 条）"),
